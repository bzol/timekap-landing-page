...
<path fill="#ed4c5c" d="M19.044 29.792l2.829-2.828l2.828 2.828l-2.828 2.829z">
                  ...
                  <button 
                    type="button" 
                    className="bg-[#5865F2] text-[#fdf8f3] hover:bg-[#4752C4] px-12 py-5 mb-4 rounded-full text-4xl font-semibold transition-colors duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center gap-3"
