    ...
    <div className="min-h-screen bg-[#fdf8f3] flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Join TimeKap with your exclusive invite code</p>
        </div>

        {inviteKey ? (
          <div className="mb-8">
            <div className="bg-[#ffce3e] rounded-lg p-6 mb-4">
            ...
            <p className="text-sm text-gray-500">
              Use this code when you sign up in the TimeKap app
            </p>
          </div>
        ) : (
          <div className="mb-8">
        ...
        <div className="space-y-4">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Download TimeKap</h2>
          
          <button
            onClick={() => handleDownload('ios')}
            className="w-full bg-black text-white py-3 px-6 rounded-lg font-medium hover:bg-gray-800 transition-colors duration-200 flex items-center justify-center gap-3"
          >
          ...
          <button
            ...
            className="w-full bg-green-600 text-white py-3 px-6 rounded-lg font-medium hover:bg-green-700 transition-colors duration-200 flex items-center justify-center gap-3"
          >
            <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <p className="text-xs text-gray-500">
            Don't have the app yet? Download it from your device's app store and use your invite code to get started.
          </p>
        </div>
      </div>
    </div>
